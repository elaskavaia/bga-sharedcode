...
namespace Bga\GameFramework {
    ...
    class Table {
         ...
         */
        function isCurrentPlayerZombie(): bool {
            return false;
        }
         ...
         * @return void
         */
        function eliminatePlayer(int $player_id): void {
        }
         ...
         */
        function getNextPlayerTable(): array {
         ...
         * @return array<int, int>
         */
        function getPrevPlayerTable(): array {
            $players = $this->loadPlayersBasicInfos();
         ...
         */
        function getPlayerAfter(int $playerId): int {
         ...
         */
        function getPlayerBefore(int $playerId): int {
         ...
         * @return void
         */
        function setGameStateInitialValue(string $label, int $value): void {
         ...
         */
        function getGameStateValue(string $label, ?int $default = null): int|string {
         ...
         * @return void
         */
        function setGameStateValue(string $label, int $value): void {
            $this->_gameStateValues[$label] = $value;
        }
         ...
         */
        function incGameStateValue(string $label, int $increment): int {
         ...
         */
        function notifyAllPlayers(string $notificationType, string $notificationLog, array $notificationArgs): void {
            $this->debugLastNotif = [
         ...
         */
        function notifyPlayer(int $playerId, string $notificationType, string $notificationLog, array $notificationArgs): void {
            $this->debugLastNotif = [
                'type' => $notificationType,
                'log' => $notificationLog,
                'args' => $notificationArgs,
         ...
         */
        function checkAction(string $actionName, bool $bThrowException = true): bool {
            return true;
        }
         ...
         */
        function initStat(string $tableOrPlayer, string $name, int $value, ?int $playerId = null): void {
        }
         ...
         * @return void
         */
        function reloadPlayersBasicInfos(): void {
        }
         ...
         */
        function storeLegacyData(int $playerId, string $key, array $data, int $ttl = 365): void {
        }
         ...
         */
        function storeLegacyTeamData(array $data, int $ttl = 365): void {
        }
         ...
         */
        function retrieveLegacyData($playerId, $key): array {
            return [];
        }
         ...
         */
        function retrieveLegacyTeamData(): array {
            return [];
        }
         ...
         */
        function removeLegacyData(int $playerId, string $key): void {
        }
         ...
         */
        function removeLegacyTeamData(): void {
        }
...
namespace Bga\GameFramework\Db {
    class Globals {
        ...
        public function delete(string ...$names): void {
            foreach ($names as $n) unset($this->data[$n]);
        }
        ...
        public function getAll(string ...$names): array {
            if (empty($names)) return $this->data;
...
namespace {
    ...
    class APP_Template {
        ...
        function begin_block(string $template_name, string $block_name): void {
        }

        function begin_subblock(string $template_name, string $block_name): void {
        }

        function insert_block(string $block_name, array $tpl = []): void {
        }

        function insert_subblock(string $block_name, array $tpl = []): void {
        }
