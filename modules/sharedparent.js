...
define(["dojo", "dojo/_base/declare", "ebg/core/gamegui"], function (dojo, declare) {
  return declare("bgagame.sharedparent", ebg.core.gamegui, {
    ...
    setup: function (gamedatas) {
      ...
      else this.player_color = gamedatas.players[this.first_player_id].color;
...
to parent (or you have to adjust them on oversurface) */
    ...
    /**
     * This is very generic move function that animations the object move on oversurface (by creating a phantom clone)
     * That should work every parents of object has other css transormations applies, such as scaling and rotation
     */
